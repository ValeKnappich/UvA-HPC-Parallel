...
void vectorAddCuda(int n, float* a, float* b, float* result) {
    ...
    cudaHostRegister(a, n * sizeof(float), cudaHostRegisterDefault);
    cudaHostRegister(b, n * sizeof(float), cudaHostRegisterDefault);
    cudaHostRegister(result, n * sizeof(float), cudaHostRegisterDefault);
